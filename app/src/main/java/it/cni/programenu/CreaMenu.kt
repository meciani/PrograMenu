...
class CreaMenu : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_menuV.setOnClickListener {
            var veloce = Menu(creatorUid.toString(),"Menu Veloce","dal "+dataCorrenteString+" al "+dataFuturaString,"Giorno 1:\n" +
                    ...
                    "Colazione: yogurt con muesli e frutta fresca\n" +
                    "Pranzo: zuppa di pomodoro con pane integrale\n" +
                    "Cena: pollo alla griglia con verdure al vapore","Avena,latte,Pollo,Verdure,Pane Integrale,Tonno,Fagioli,yogurt,muslei,frutta pasta")
        ...
        btn_menuB.setOnClickListener {
            val base = Menu(creatorUid.toString(),"Menu Base","dal "+dataCorrenteString+" al "+dataFuturaString,"Giorno 1:\n" +
                    ...
                    "Colazione: frittata di verdure e avocado\n" +
                    "Pranzo: insalata di quinoa con pollo alla griglia e verdure\n" +
                    "Cena: pesce al forno con patate e verdure","Avena,latte,Pollo,Verdure,Pane Integrale,Tonno,Fagioli,yogurt\n"+"" +
        ...
        btn_menuS.setOnClickListener {
            val sofisticato = Menu(creatorUid.toString(),"Menu Sofisticato","dal "+dataCorrenteString+" al "+dataFuturaString,"Giorno 1:\n" +
